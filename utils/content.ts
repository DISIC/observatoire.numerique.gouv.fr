...
export const ACCESSIBILITE = {
    declaration: "La direction interministérielle du numérique (DINUM) s’engage à rendre ses sites internet accessibles conformément à l’article 47 de la loi n° 2005-102 du 11 février 2005.",
    introStrategy: "À cette fin, il met en œuvre la stratégie et les actions suivantes :",
    strategy: [
                    {text: "Consulter le schéma pluriannuel d’accessibilité 2020-2022 (pdf - 1,7 Mo)", link: "https://www.numerique.gouv.fr/uploads/DINUM_SchemaPluriannuel_2020.pdf"},
                    {text: "Consulter le plan annuel d’accessibilité 2021 (pdf - 900 Ko)", link: "https://www.numerique.gouv.fr/uploads/DINUM-plan-annuel-2021.pdf"}
    ],
    strategyEnd: "Cette déclaration d’accessibilité s’applique au service Vos démarches essentielles.",
    conformity: "Le service Vos démarches essentielles est en conformité partielle avec le référentiel général d'amélioration de l'accessibilité (RGAA), version 4.1. Les non-conformités sont énumérées ci-dessous.",
    testResultIntro: "L’audit de conformité finalisé le 1er juillet 2021 en interne révèle que :",
    testResults: ["53,4 % des critères RGAA sont respectés.", "Le taux moyen de conformité du service en ligne s’élève à 78,2%."],
    nonAccessibleContent: {
        contentIntro: "Les contenus listés ci-dessous ne sont pas accessibles pour les raisons suivantes :",
        images: [
        ...
        cgu: ["Lorsqu’on active le bouton “Refuser le suivi de votre navigation”, la page se recharge sans que l’utilisateur en ait été averti au préalable. "],
        structuration: [
    ...
    testPageIntro: "Les tests des pages web ont été effectués avec les combinaisons de navigateurs web et lecteurs d’écran suivants :",
    testTools: ["NVDA 2021.4 et Firefox 89.0.2", "Jaws 2021 et Firefox 89.0.2", "VoiceOver et Safari, OS 11.0.1"],
    toolsIntro: "Les outils suivants ont été utilisés lors de l’évaluation",
    toolsEval: ["Barre d’outil Web Developer", "Extensions : WAVE, WCAG Color contrast checker et HeadingsMaps"],
    verifiedPagesIntro : "Pages du site ayant fait l’objet de la vérification de conformité",
    verifiedPages: [
        { text: "Accueil", link: "/" },
        ...
        { text: "En savoir plus sur nos critères d'évaluation", link: "/Aide/Observatoire" }
    ],
    rightToCompensation: "Dans l’attente d’une mise en conformité totale, vous pouvez obtenir une version accessible des documents ou des informations qui y seraient contenues en envoyant un courriel à communication.dinum@modernisation.gouv.fr en indiquant le nom du document concerné et/ou les informations que vous souhaiteriez obtenir. Les informations demandées vous seront transmises dans les plus bref délais.",
    contact: "Vous pouvez nous aider à améliorer l’accessibilité du site en nous signalant les problèmes éventuels que vous rencontrez. Pour ce faire, envoyez-nous un courriel à communication.dinum@modernisation.gouv.fr.",
    ...
    defenderOfRights: {
        phone: "un numéro de téléphone : le 09 69 39 00 00 du lundi au vendredi de 8h00 à 20h00 (coût d'un appel local)",
        postal: "une adresse postal (envoi de courrier gratuit, ne pas mettre de timbre) : Défenseur des droits - Libre réponse 71120 - 75342 Paris CEDEX 07"
    }
};