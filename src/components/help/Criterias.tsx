	...
	return (
		<div className={classes.root}>
			...
			<ol>
				...
				<li>
					L’administration déclare directement aux équipes de la DINUM son
					intention de vouloir rejoindre ce dispositif ;
				</li>
				<li>
			...
			<p>
				...
				vérifient la conformité de la démarche ou service aux critères
				susmentionnés. Ensuite elle travaille avec l’équipe concernée afin de
				recueillir toutes les informations nécessaires à l’évaluation de la
				démarche ou service et entrer dans une dynamique d’accompagnement à son
				amélioration.
			</p>
